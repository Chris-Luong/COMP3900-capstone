...
FROM tables t
LEFT JOIN bookings b ON t.id = b.table_id AND b.date = ? AND ((b.start_time <= ? AND b.end_time > ?) 
...
SELECT b.id as bookId, a.lastname AS userName, t.id as tableId, t.tableName as tableName, b.start_time as bookingStart, b.end_time as bookingEnd, b.guests as guests
FROM bookings b
