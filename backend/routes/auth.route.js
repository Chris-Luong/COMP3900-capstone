...
const { viewOrders, createOrder, deleteOrder, setNewTable, getOrdersForTableId, viewPendingOrders } = require("../controller/order");
...
router.get("/orders/pending", viewPendingOrders)
